...
use moviedb;
create table moviedb.movies (id VARCHAR(200), name VARCHAR(200),picture VARCHAR(200),rating FLOAT(3,2));
create table moviedb.comments_to_be_reviewed (movie_id VARCHAR(50), comment VARCHAR(2000));
